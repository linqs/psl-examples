...
readonly DATA_URL='https://linqs-data.soe.ucsc.edu/public/psl-examples-data/citation-categories.tar.gz'
readonly DATA_FILE='citation-categories.tar.gz'
readonly DATA_DIR='citation-categories'
