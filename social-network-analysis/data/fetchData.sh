...
readonly DATA_URL='https://linqs-data.soe.ucsc.edu/public/psl-examples-data/social-network-analysis.tar.gz'
readonly DATA_FILE='social-network-analysis.tar.gz'
