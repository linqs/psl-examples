...
readonly DATA_URL='https://linqs-data.soe.ucsc.edu/public/augustine-nips17-data/collective-classification/splits.tar.gz'
readonly DATA_FILE='citeseer.tar.gz'
